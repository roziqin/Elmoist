		...
		<div class="row header-content pt-3 pb-0 info-color text-white">
			...
			<div class="col-md-12 pl-0 pr-0 ">
				<ul class="nav">
				    ...
				    <li class="nav-item">
				      <a class="nav-link waves-light" id="semuamember">Semua Member</a>
				    </li>
				    <li class="nav-item">
				    ...
				    <li class="nav-item">
				      <a class="nav-link waves-light" id="persediaan">Persediaan</a>
				    </li>
				    <!--
				    <li class="nav-item">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('.nav-link').click(function(){
				...
				} else if(menu == "semuamember"){
					$('.container__load').load('components/content/laporan.content.php?ket=semuamember');			
				} else if(menu == "mutasi"){
				...
				} else if(menu == "persediaan"){
					$('.container__load').load('components/content/laporan.content.php?ket=persediaan');			
				}
			});
